                        ...
                        <div className="row h-100 justify-content-center align-items-center">
                            <div className="col-6 bg-secondary p-5 rounded text-white">
                                ...
                                <div className="form-group">
                                    ...
                                    <input type="text" name="email" className="form-control" id="formGroupExampleInput" placeholder="Example input" ref={register(
                                        {
                                            pattern: {
                                                value: /^\w+([\.-]?\w+)*@\w+([\.-]?\w+)*(\.\w{2,3})+$/,
                                ...
                                <div className="form-group">
                                    ...
                                    <input type="password" name="password" className="form-control" id="formGroupExampleInput2" placeholder="Another input" ref={
                                        register(
                                            {
